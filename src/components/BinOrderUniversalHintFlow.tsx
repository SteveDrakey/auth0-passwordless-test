...
interface BinOrderUniversalHintFlowProps {
  onBack: () => void;
}
...
export default function BinOrderUniversalHintFlow({ onBack }: BinOrderUniversalHintFlowProps) {
  ...
  async function handleSignIn() {
    ...
    setLoading(true);
    try {
      sessionStorage.setItem("mfa-return-flow", "bin-universal-hint");
      const url = await getMfaLoginUrl(email);
  ...
  return (
    <>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Universal Login with login_hint — email pre-filled from your request</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
        ...
        {/* Step 1: Your request — collects email here */}
        {step === "request" && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. 12 Roundhay Park Lane, Leeds, LS8 2HG"
              />
            </div>
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Your email will be pre-filled on the Auth0 login page</p>
            </div>
            <button
              ...
              disabled={!binType || !address || !email}
          ...
          <div className="space-y-5">
            ...
            <div className="bg-amber-50 border-l-4 border-accent rounded-r-lg p-5">
              ...
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
                You'll be redirected to Auth0 to sign in. Your email <strong>{email}</strong> will
                be pre-filled using <code className="text-xs bg-white/60 px-1 py-0.5 rounded">login_hint</code> so
                you only need to enter your password and complete MFA.
              </p>
              <button
        ...
        {step === "done" && (
          <div className="text-center py-6">
            ...
            <button
              ...
              onClick={() => { setStep("request"); setBinType(""); setAddress(""); setEmail(""); setAccessToken(""); setError(""); }}
            >
              Start again
            </button>
          </div>
